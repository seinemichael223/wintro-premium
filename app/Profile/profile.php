    ...
    <div class="management-container">
        ...
        <div class="manage-account">
            ...
            <div id="address-content" class="section hidden">
                ...
                <button onclick="window.location.href='../includes/edit_address.php';" class="edit-btn">Edit Address</button>

                <?php if ($address): ?>
                    <div class="address-card">
                        <p><?php echo htmlspecialchars($address['address_street']); ?></p>
                        <p><?php echo htmlspecialchars($address['address_city']) . ', ' .
                                htmlspecialchars($address['address_state']) . ' ' .
                                htmlspecialchars($address['address_zip']); ?></p>
                        <p><?php echo htmlspecialchars($address['address_country']); ?></p>
                    </div>
                <?php else: ?>
                ...
                <?php if ($orders): ?>
                    <ul>
                        <?php foreach ($orders as $order): ?>
                            <li>Order <?php echo htmlspecialchars($order['id']); ?> - Date: <?php echo htmlspecialchars($order['order_date']); ?></li>
                        <?php endforeach; ?>
                    </ul>
                <?php else: ?>
                    <p>No orders found.</p>
