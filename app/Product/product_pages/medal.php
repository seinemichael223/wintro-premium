...
$sql_total = "
    SELECT COUNT(*) FROM product WHERE sub_category_id = 2 
...
$sql = "
    SELECT * FROM product WHERE sub_category_id = 2 
    AND product_unit_price BETWEEN ? AND ?
    LIMIT ? OFFSET ?;
...
<body>
    ...
    <div class="smallNav">
        <ul>
            ...
            <p>|</p>
            <li><a href="#"><span class="colored">Medal</span></a></li>
        </ul>
    </div>
                ...
                <ul>
                    <li>
                        ...
                        <ul class="award-show">
                            ...
                            <li><a href="#"><span class="highlighted">Medal</a></li>
