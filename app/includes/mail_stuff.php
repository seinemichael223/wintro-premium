...
function notify_mail($username, $mailAddress) {
    try {
        ...
        $mail->Username   = 'riverseine223@gmail.com';                    // SMTP username
        $mail->Password   = 'wrml ggee uelu aeep';                               // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            // Enable implicit TLS encryption
        $mail->Port       = 465;                                    // TCP port to connect to

        // Recipients
        $mail->setFrom('riverseine223@gmail.com');   // Set sender email and name
        ...
        echo "<script>
                ...
                document.location.href = '../Reg_Login/login.php';
              </script>";
    } catch (Exception $e) {
        echo "<script>
